...
\node at (5.5 ,-9   )        [box] (TRBLOC) {use \texttt{bl1v} matrices};
...
\node at (CONTAP.north west) [lbl]          {\texttt{470}};
...
\node at (CONTDU.north west) [lbl]          {\texttt{475}};
...
\node at (CONTEN.north west) [lbl]          {\texttt{480}};
\node at (0   ,-35.5)        [cbx] (SOMEIO) {some I/O};
\node at (0   ,-37  )        [box] (CONTTU) {\texttt{continue}};
\node at (CONTTU.north west) [lbl]          {\texttt{490}};
