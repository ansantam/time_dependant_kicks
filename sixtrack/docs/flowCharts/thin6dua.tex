...
\node at (CONTEN.north west) [lbl]          {\texttt{650}};
\node at (0   ,-35.5)        [cbx] (SOMEIO) {some I/O};
\node at (0   ,-37  )        [box] (CONTTU) {\texttt{continue}};
\node at (CONTTU.north west) [lbl]          {\texttt{660}};
